...
public class GlucosascActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_glucosasc);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent intent = new Intent(GlucosascActivity.this, AnalisisexitosoActivity.class);
